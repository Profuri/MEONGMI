    ...
    public class MenuItem : MonoBehaviour //monobehaviour is required for destroy immediate/instantiate etc.
    {
        ...
        static void CheckForRayCaster()
        {
            ...
            if (xRToolkitGlobalInputControllerForModularTextAsset != null)
            {
                ...
                {
                    GameObject inputSystemGameObject = new GameObject("MText UI controller for XR");
                    Undo.RegisterCreatedObjectUndo(inputSystemGameObject, "MText UI controller for XR");
        ...
        {
            GameObject inputSystemGameObject = new GameObject("M3D Input System");
            Undo.RegisterCreatedObjectUndo(inputSystemGameObject, "Create M3D Input System");
            inputSystemGameObject.transform.SetPositionAndRotation(Vector3.zero, Quaternion.identity);
